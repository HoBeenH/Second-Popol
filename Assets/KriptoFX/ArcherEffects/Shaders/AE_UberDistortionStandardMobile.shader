Shader "KriptoFX/AE/DistortionMobile"
{
	Properties
	...
	#include "UnityCG.cginc"
				...
				half4 frag(v2f i) : SV_Target
				{
					...
					half2 texelSize = 0.0015;
					half2 offset = dist.rg * _Distortion * texelSize * i.color.a;
		...
		CustomEditor "AE_UberDistortionShaderGUI"
}
