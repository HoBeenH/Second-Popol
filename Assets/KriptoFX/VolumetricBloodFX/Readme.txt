...
For example instead of the default 2 meters you can use 6 meters or more. In this case the decal will be projected 쟴o world height position from -3 to 3 meters.
