...
namespace Script.Player
{
    public class M_Player_HeavyShoot : State<PlayerController>
    {
        ...
        {
            _SkillManager.AddSkill(typeof(M_Player_HeavyShoot),15f);
        }
        ...
        private IEnumerator SetEffect()
        {
            ...
            var _pos = _EffectManager.spawnPosFw.position;
            var _leftHand = _EffectManager.leftHand;
            var _rightHand = _EffectManager.rightHand;
